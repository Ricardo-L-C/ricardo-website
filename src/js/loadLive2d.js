const modelList = [
    ...
    ["static/model/hijiki/hijiki.model.json", "static/model/tororo/tororo.model.json"],
...
export default function loadLive2d() {
    ...
    let randomSkin = Math.floor(Math.random() * modelList[randomModel].length);
    loadlive2d("live2d", modelList[randomModel][randomSkin]);
}